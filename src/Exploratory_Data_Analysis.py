...
figname = ("###path_to/Unbalanced dataset.png")
plt.savefig(figname, dpi = 600)

plt.show()

# There is a high inbalance in the amount of data for different wine classes, so 
# let's join some of them
...
figname = ("###path_to/Balanced dataset.png")
plt.savefig(figname, dpi = 600)
...
# Adding a constant for the VIF regression procedure
x = add_constant(wine)
...
# Generate a mask for the upper diagonal matrix
mask1 = np.triu(np.ones_like(corr, dtype=bool))

# modify the correlation threshold if needed
threshold = 0
...
figname = ("###path_to/heatmap_originalFeatures.png")
plt.savefig(figname, dpi = 600)
...
figname = ("###path_to/heatmap_modifiedFeatures.png")
plt.savefig(figname, dpi = 600)
...
##################################
# It is always important to check for patterns in the data that 
# could result in a low Pearson correlation coefficient, 
# even if there is a strong relationship between the variables. 
...
figname = ("###path_to/scatter_plot_withoutTarget_modifiedFeatures.png")
plt.savefig(figname, dpi = 600)
...
figname = ("###path_to/scatter_plot_withTarget_modifiedFeatures.png")
plt.savefig(figname, dpi = 600)
